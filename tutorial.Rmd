...
To visualise the most differentially-expressed genes, we first need to extract their *IDs*. These IDs should correspond to rows in the expression matrix.
...
Bioconductor annotation packages exist to allow easy conversion between different ID schemes
